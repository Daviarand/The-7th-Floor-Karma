...
public class MinimapCamera : MonoBehaviour
{
    ...
    [Header("Camera Settings")]
    public float viewSize = 6f;
    public float mapRotationY = 0f; // Rotasi Y 
    public float mapRotationZ = 90f; // Rotasi Z untuk orientasi landscape
    public Color backgroundColor = Color.black; 
    public bool disableShadows = true; // Opsi matikan shadow agar map bersih
    ...
    void LateUpdate()
    {
        if (playerTarget != null)
        {
            ...
            // Z=90 untuk landscape orientation
            transform.rotation = Quaternion.Euler(90f, mapRotationY, mapRotationZ);
